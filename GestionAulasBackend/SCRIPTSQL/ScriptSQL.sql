...
insert into `persona` values (1,'Silvestri',41354292,'Matias','DNI');
insert into `persona` values(2,'Hamilton',12345678,'Lewis','DNI');
insert into `user` values('matias@gmail.com', '$2a$10$lpeTNBUGJfHxsJNOkAF5IuS5eLZUOuL8vlHMd/9O0rL5Cb3rp.uk6','ADMIN','admin',1);
insert into `user` values('lewishamilton@gmail.com', '$2a$10$1XJ4XIFcFkzEZxtti3ae2OZN1.0gy9/bFdENTuGeOMRfcO7ZbszkW','USER','user',2);
